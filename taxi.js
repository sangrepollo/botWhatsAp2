...
async function run() {
    try {
        ...
        const groupJIDs = [
            ...
            // Agrega más JIDs de grupos aquí
        ];
        ...
        function shouldOpenGroup() {
            ...
            const timeStr = `${hours.toString().padStart(2, '0')}:${minutes.toString().padStart(2, '0')} AM`;

            // El grupo estará abierto si la hora actual está entre 8:00 AM y 11:59 PM
            return timeStr >= '08:00 AM' && timeStr <= '11:59 PM';
        }
